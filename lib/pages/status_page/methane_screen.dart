...
class MethaneScreen extends StatefulWidget {
  const MethaneScreen({Key? key}) : super(key: key);

  @override
  _MethaneScreenState createState() => _MethaneScreenState();
}

class _MethaneScreenState extends State<MethaneScreen> {
  @override
